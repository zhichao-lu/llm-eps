...
"""A single-threaded funsearch_impl of the FunSearch pipeline."""
...
from funsearch_impl import profile
...
def main(
    ...
    # We send the initial funsearch_impl to be analysed by one of the evaluators.
