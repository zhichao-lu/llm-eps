...
class Sampler:
    ...
    def sample(self, **kwargs):
        ...
        while True:
            ...
            # in random search, we only save the first prompt
            if self.__class__._first_prompt == '':
                self.__class__._first_prompt = prompt.code

            reset_time = time.time()
            samples = self._llm.draw_samples(self.__class__._first_prompt)
