...
"""A single-threaded rand_search_impl of the FunSearch pipeline."""
...
from rand_search_impl import config as config_lib
from rand_search_impl import evaluator
from rand_search_impl import programs_database
from rand_search_impl import sampler
from rand_search_impl import profile
...
def main(
    ...
    if log_dir is None:
        ...
        profiler = profile.Profiler(log_dir, resume_run=resume_run)
    ...
    # We send the initial rand_search_impl to be analysed by one of the evaluators.
