...
from hill_climb_impl import profile
from hill_climb_impl import code_manipulation
from hill_climb_impl import config as config_lib
...
class Prompt:
    ...
    Attributes:
      ...
      island_id: Identifier of the island that produced the implementations
         included in the prompt. Used to direct the newly generated rand_search_impl
...
class ProgramsDatabase:
    ...
    def _register_program_in_island(
        ...
        if profiler:
            ...
            profiler.record_program_nums_in_island([island.get_num_programs() for island in self._islands])
        # ===============================================================================
    ...
    def register_program(
        ...
        # In an asynchronous rand_search_impl we should consider the possibility of
...
class Cluster:
    ...
    def sample_program(self) -> code_manipulation.Function:
        ...
        return profile.Profiler.the_best_function
